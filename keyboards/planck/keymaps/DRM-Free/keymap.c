...
[_BASE] = LAYOUT_planck_grid(
    ...
    KC_DEL,TD(CT_QUOTE_W),TD(CT_DQUOTE_I),TD(CT_BACKSLASH_N),TD(CT_EXCL_O),TD(CT_INTER_M),MT(MOD_LCTL,FR_L),TD(CT_Ù_U),KC_UP,TD(CT_CIRC_V),MT(MOD_LSFT,FR_J), TD(CT_PAR),
